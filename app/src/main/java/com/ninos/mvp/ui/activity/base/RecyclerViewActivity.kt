 ...
 */
abstract class RecyclerViewActivity<P : RecyclerViewPresenter<*, *>, A : BaseAdapter<*, B, P>, B> : ToolBarActivity<P>(), OnItemClickListener<B>, LoadMoreView {
     ...
     * @param dy
     */
    open protected fun onscroll(recyclerView: RecyclerView, dx: Int, dy: Int) {}
    ...
    fun bd(data: ArrayList<B>) {
        if (page == 1) adapter!!.addDatas(data) else adapter!!.addMore(data)
    }
