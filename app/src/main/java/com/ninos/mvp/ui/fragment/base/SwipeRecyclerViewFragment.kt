...
import com.ninos.mvp.ui.activity.base.SwipeRefreshFragment

/**
 * Created by ninos on 2017/6/1.
 */
abstract class SwipeRecyclerViewFragment<P : RecyclerViewPresenter<*, *>, A : BaseAdapter<*, B, P>, B> : SwipeRefreshFragment<P>(), OnItemClickListener<B>, LoadMoreView {
